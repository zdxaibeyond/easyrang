$(function(){
   ...
   function newCTF(){
     ...
     //CTF比赛 管理
     $CTF.on("click","tbody>tr td:nth-child(8) a:nth-child(1)",function(){
           var _self=$(this);
           var data={
               cffName:"这个是CTF比赛",
               classification:"小组赛",
     ...
     $CTF.on("click","tbody>tr td:nth-child(7) a",function(){
        var _self=$(this); 
        alert(_self.attr('id'));
           $("#content").load('CTFGradingManagement.html');
           $('.pageheader h2 span').text("CTF评分管理");
        })

      //CTF比赛 删除
     $CTF.on("click","tbody>tr td:nth-child(8) a:nth-child(2)",function(){
           var _self=$(this);
